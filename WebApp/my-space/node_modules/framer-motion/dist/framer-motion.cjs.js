...
function calcTranslate(source, target, origin) {
    var sourcePoint = popmotion.mix(source.min, source.max, origin);
    var targetPoint = popmotion.mix(target.min, target.max, origin);
...
function getAnimation(key, value, target, transition, onComplete) {
    ...
    function start() {
        ...
        return valueTransition.type === "inertia" ||
            ...
            : popmotion.animate(getPopmotionAnimationOptions(valueTransition, options, key));
    }
    function set() {
        value.set(target);
        onComplete();
...
var AnimationControls = /** @class */ (function () {
    ...
    AnimationControls.prototype.mount = function () {
        ...
        this.pendingAnimations.forEach(function (_a) {
            ...
            return _this.start.apply(_this, tslib.__spread(animation)).then(resolve);
        });
    };
    /**
...
var VisualElementAnimationControls = /** @class */ (function () {
    ...
    VisualElementAnimationControls.prototype.resolveVariant = function (variant, _a) {
        ...
        var _b = variant.transition, transition = _b === void 0 ? this.defaultTransition : _b, transitionEnd = variant.transitionEnd, target = tslib.__rest(variant, ["transition", "transitionEnd"]);
    ...
    VisualElementAnimationControls.prototype.getHighestPriority = function () {
        if (!this.activeOverrides.size)
            return 0;
        return Math.max.apply(Math, tslib.__spread(Array.from(this.activeOverrides)));
    };
    /**
    ...
    VisualElementAnimationControls.prototype.applyVariantLabels = function (variantLabelList) {
        ...
        var reversedList = tslib.__spread(variantLabelList).reverse();
    ...
    VisualElementAnimationControls.prototype.animate = function (animationDefinition, _a) {
        var _this = this;
        if (_a === void 0) { _a = {}; }
        var _b = _a.delay, delay = _b === void 0 ? 0 : _b, _c = _a.priority, priority = _c === void 0 ? 0 : _c, transitionOverride = _a.transitionOverride, opts = tslib.__rest(_a, ["delay", "priority", "transitionOverride"]);
    ...
    VisualElementAnimationControls.prototype.animateVariant = function (variantLabel, opts) {
        ...
        if (when) {
            var _a = tslib.__read(when === "beforeChildren"
...
function useReducedMotion() {
    ...
    var _a = tslib.__read(React.useState(determineShouldReduceMotion(prefersReducedMotion.get(), isReducedMotion)), 2), shouldReduceMotion = _a[0], setShouldReduceMotion = _a[1];
    React.useEffect(function () {
